...
graph TD
    subgraph Browser["BROWSER ENVIRONMENT"]
        subgraph React["REACT APPLICATION"]
            UI["**UI Layer**<br/>Components<br/>Layouts<br/>Styles"]
            Game["**Game Logic**<br/>Card Gen<br/>Win Check<br/>Scoring"]
            Speech["**Speech Recognition**<br/>Web Speech API<br/>Transcript Processing<br/>Word Detection"]

            UI & Game & Speech --> Context["Context State"]
...
graph LR
    ...
    D --> E["Match Found?"] --> F["Fill Square"] --> G["Update UI"]
```
...
```mermaid
graph LR
    A["Square Filled"] --> B["Check Lines"] --> C["BINGO? Yes!"] --> D["Celebrate & Share"]
```
...
```mermaid
graph TD
    MP["**FUTURE: MULTIPLAYER**"]

    MP --> A["**Option A: WebSocket Server**<br/>Requires Backend"]
    MP --> B["**Option B: Peer-to-Peer**<br/>WebRTC"]
    MP --> C["**Option C: Firebase**<br/>Realtime Database"]

    A --> A1["Real-time sync across players<br/>Shared game state<br/>Live leaderboard<br/>Cost: $5-20/month"]
    B --> B1["No backend required<br/>Direct browser connections<br/>Limited to ~10 players<br/>Cost: Free"]
    C --> C1["Managed real-time sync<br/>Free tier generous<br/>Easy implementation<br/>Cost: Free up to 100 concurrent"]
```
